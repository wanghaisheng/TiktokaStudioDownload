...
def privacy() -> None:
    ...
    Your privacy is important to us. It is Tiktoka Downloader's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, [https://tiktokvideos.download](https://tiktokvideos.download/), and other sites we own and operate.
    ...
    * third parties to collect and process data
    ...
    Tiktoka Downloader
    [tiktokadownloader@gmail.com](mailto:tiktokadownloader@gmail.com)
    """, lstrip=True,
    )
